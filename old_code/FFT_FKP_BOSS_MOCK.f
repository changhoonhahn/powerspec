...
c      write(*,*)'file with number density array'
c      read(*,'(a)')selfunfile
c      open(unit=3,file=selfunfile,status='old',form='formatted')
c      do l=1,Nsel
c               read(3,*,end=12) zt, numden
...
c      call spline(z,selfun,Nsel,3e30,3e30,sec)
...
c         write(*,*)'Name of spline/splint test file'
c         read(*,'(a)')spltest
c         open(unit=7,file=spltest,action='write',status='replace') 
         do i=1,Nmax
