pro fibcoll_dlos_fit, n 
    datadir = '/mount/riachuelo1/hahn/data/manera_mock/dr11/' 
    fname   = 'cmass_dr11_north_ir4'+strmid(strtrim(string(n+1000),1),1)+'.v7.0.wghtv.txt'
    print,datadir+fname
...
;    spherematch, ra_upcp, dec_upcp, ra_nocp, dec_nocp, fib_angscale, m_upcp, m_nocp, d12, maxmatch=0
    ...
    openw,lun,datadir+'cmass_dr11_north_ir4'+strmid(strtrim(string(n+1000),1),1)+'v7.0_dlos.dat',$
       /get_lun
