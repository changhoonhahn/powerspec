pro fibcoll_pthalo_v11p0_dlos, n 
    datadir = '/mount/riachuelo1/hahn/data/manera_mock/dr11test/' 
    fname   = 'cmass_dr11_north_ir4'+strmid(strtrim(string(n+1000),1),1)+'.v11.0.wghtv.txt'
    print,datadir+fname
...
;Angular Fiber Collision Scale: 
    ...
    openw,lun,datadir+'cmass_dr11_north_ir4'+strmid(strtrim(string(n+1000),1),1)+'v11.0_dlos.dat',$
       /get_lun
