...
n = len(nrange)
for i in nrange: 
    print 'cmass_dr10_north_ir4'+str(i+1000)[1:4]+'v5.2_dlos.dat'
    disp_los    = np.loadtxt(dir+'cmass_dr10_north_ir4'+str(i+1000)[1:4]+'v7.0_dlos.dat')
    data        = np.loadtxt(dir+'cmass_dr10_north_ir4'+str(i+1000)[1:4]+'.v7.0.wghtv.txt')
