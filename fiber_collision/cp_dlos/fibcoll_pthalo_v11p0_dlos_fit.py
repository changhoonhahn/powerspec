...
dir = '/mount/riachuelo1/hahn/data/manera_mock/dr11test/'
...
n = len(nrange)
for i in nrange: 
    print 'cmass_dr11_north_ir4'+str(i+1000)[1:4]+'v11.0_dlos.dat'
    disp_los    = np.loadtxt(dir+'cmass_dr11_north_ir4'+str(i+1000)[1:4]+'v11.0_dlos.dat')
...
#ax1.plot(disp_los_x[10000:10500],expon(np.array(disp_los_x[10000:10500]),popt[0],popt[1]), 'r', linewidth=3, label=r'Exponential distribution with $\sigma=$'+str(popt[0])[0:6]+' and $A=$'+str(popt[1])[0:6])
