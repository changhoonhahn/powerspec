...
ifort -O3 -o FFT-fkp-mock-dr11-v7p0-wbossonly_360grid.exe FFT-fkp-mock-dr11-v7p0-wbossonly_360grid.f -L/usr/local/fftw_intel_s/lib -lsfftw -lsfftw
...
do
    ...
    ./FFT-fkp-mock-dr11-v7p0-wbossonly_360grid.exe $Rbox 0 $P0 $datadir$nbarfname $fname $FFTname
