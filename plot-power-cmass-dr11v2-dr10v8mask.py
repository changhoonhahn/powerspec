...
S_dr11v2_mask_360 = np.loadtxt(riadir+'power-cmass-dr11v2-S-Anderson-nzw-zlim-dr10v8mask-ngalsys-3600lbox-360bin-180bin.dat')
###################################################################################
...
powax01.scatter(S_dr11v2_360[:,0],S_dr11v2_360[:,1],color='r', label=r"P(k) for DR11v2 South")
powax01.loglog(S_dr11v2_mask_360[:,0],S_dr11v2_mask_360[:,1],'k',linewidth=2, label=r"P(k) for DR11v2 South with DR10v8 Mask") 
