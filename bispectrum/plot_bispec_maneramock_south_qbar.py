...
ax40.scatter( range( 0, len(Q_avg) ), Q_avg, s=7, c='r', label=r"$\overline{Q_{123,Mock-v5p2-South}}$" )
...
fig1.savefig(figdir+'bispec_maneramock_v5p2_S_all_qbar.png')
fig2.savefig(figdir+'bispec_maneramock_v5p2_S_all_deltaq_qbar.png')
fig3.savefig(figdir+'bispec_cmass_dr10v8_S_Qboss_Qbarmock_ratio.png')
fig4.savefig(figdir+'bispec_cmass_dr10v8_S_Qboss_Qbarmock.png')
fig5.savefig(figdir+'bispec_cmass_dr10v8_S_Qboss_Qbarmock_SigNoise.png')
#py.show()
