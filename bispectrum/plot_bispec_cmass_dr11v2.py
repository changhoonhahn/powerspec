...
bispec_fname = 'bispec-cmass-dr11v2-'+NS+'-ngalsys-3600lbox-360bin-180bin.dat.grid.nmax40.nstep3.P020000.box3600'
power_dir = '/mount/riachuelo1/hahn/power/'
power_fname = 'power-cmass-dr11v2-'+NS+'-Anderson-nzw-zlim-ngalsys-3600lbox-360grid-180bin.dat'
...
fig0.savefig(figdir+'bispec_cmass_dr11v2_'+NS+'_powercheck.png')
fig1.savefig(figdir+'bispec_cmass_dr11v2_'+NS+'_q123.png')
fig2.savefig(figdir+'bispec_cmass_dr11v2_'+NS+'_allk_neg123.png')
py.show()
