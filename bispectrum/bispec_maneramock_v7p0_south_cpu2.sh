...
prefix="FFTcmass_dr11_south_ir4"
bispecpre="BISPcmass_dr11_south_ir4"
...
for P0 in 20000
do
    randFFTname=$FFTdir"FFTcmass_dr11_south_randoms_ir4_combined_wboss.v7.0.wghtv.txt.grid"$grid".P0"$P0".box"$box
    for i in {101..200}
    do 
        if [ $i -lt 10 ]
        then 
