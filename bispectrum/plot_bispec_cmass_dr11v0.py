...
bispec_fname = 'bispec-cmass-dr11v0-S-ngalsys-360bin-180bin.dat.grid.nmax40.nstep3.P020000.box3600'
power_dir = '/mount/riachuelo1/hahn/power/'
power_fname = 'power-cmass-dr11v0-S-Anderson-nzw-zlim-ngalsys-360bin-180bin.dat'
...
print "Number of triangles with Q_123 < 0, ", len(Q)
