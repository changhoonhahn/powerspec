...
bispec_fname0 = 'BISPcmass_dr11_north_ir4'
...
bispec_cmass_N = np.loadtxt('/mount/riachuelo1/hahn/bispec/bispec-cmass-dr11v0-N-ngalsys-360bin-180bin.dat.grid.nmax40.nstep3.P020000.box3600')
...
ax10.scatter(range(0,len(Q_avg)), Q_avg, s = 2, label = r'$\overline{Q_123}$')
...
ax20.scatter( range( 0, len(Q_avg) ), Q_scatter, s=2, label = r'$\frac{\Delta Q}{\overline{Q}}$' )
...
fig1.savefig('/home/users/hahn/figures/boss/bispectrum/bispec_maneramock_v7p0_N_all_qbar.png')
fig2.savefig('/home/users/hahn/figures/boss/bispectrum/bispec_maneramock_v7p0_N_all_delq_qbar.png')
fig3.savefig('/home/users/hahn/figures/boss/bispectrum/bispec_cmass_dr11v0_N_Qboss_Qbar_v7p0mock_ratio.png')
fig4.savefig('/home/users/hahn/figures/boss/bispectrum/bispec_cmass_dr11v0_N_Qboss_Qbar_v7p0mock.png')
fig5.savefig('/home/users/hahn/figures/boss/bispectrum/bispec_cmass_dr11v0_N_Qboss_qbar_v7p0mock_SigNoise.png')
py.show()
