...
powfig = py.figure(1,figsize=(8,5))
powax00 = powfig.add_subplot(111)

powax00.scatter(S_dr10v8_360[:,0],S_dr10v8_360[:,1],color='r',s=4,label=r"P(k) for DR10v8 South")
powax00.scatter(S_dr11v0_360[:,0],S_dr11v0_360[:,1],color='k',s=4,label=r"P(k) for DR11v0 South")
powax00.scatter(S_dr11v1_360[:,0],S_dr11v1_360[:,1],color='b',s=4,label=r"P(k) for DR11v1 South")
