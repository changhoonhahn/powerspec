#!/bin/bash
name0="cmass-dr11v2-"; nameend="-Anderson-weights-zlim"; field="N"
...
ifort -O3 -o FFT-fkp-weights-ngalsys-360grid.exe FFT-fkp-weights-ngalsys-360grid.f -L/usr/local/fftw_intel_s/lib -lsfftw -lsfftw
