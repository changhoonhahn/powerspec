...
powax00.loglog(N_dr11v1_360[:,0],N_dr11v1_360[:,1],'b--',linewidth=2, label=r"P(k) for DR11v1 North $L_{Box}=3600 Mpc/h, N_{grid}=360$")
powax00.loglog(S_dr11v1_360[:,0],S_dr11v1_360[:,1],'r--',linewidth=2, label=r"P(k) for DR11v1 South $L_{Box}=3600 Mpc/h, N_{grid}=360$")
