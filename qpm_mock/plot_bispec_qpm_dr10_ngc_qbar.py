...
ax50.loglog( kfund*uniq_kmax, Q_SN ,label=r'S/N(k) for $Q_{123}$ of 5 QPM Mocks')
...
fig1.savefig(figdir+'bispec_qpm_dr10_ngc_5mock_qbar.png')
fig2.savefig(figdir+'bispec_qpm_dr10_ngc_5mock_deltaq_qbar.png')
fig3.savefig(figdir+'bispec_cmass_dr10v8_N_qpm_5mock_Qboss_Qbarmock_ratio.png')
fig4.savefig(figdir+'bispec_cmass_dr10v8_N_qpm_5mock_Qboss_Qbarmock.png')
fig5.savefig(figdir+'bispec_cmass_dr10v8_N_qpm_5mock_Qboss_Qbarmock_SigNoise.png')
