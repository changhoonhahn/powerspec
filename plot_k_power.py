...
N = np.loadtxt(path+'POWER-cmass-dr10v5-N-Anderson-wcomp-80000p0-960grid-480bin.dat')
...
plt.plot(np.log10(N[:,0]),np.log10(N[:,1]),'m--', linewidth=3, label='P(k) for N-Anderson_960_480 (P0=80000)')
plt.plot(np.log10(S[:,0]),np.log10(S[:,1]),'b--', linewidth=3, label='P(k) for S-Anderson_960_480 (P0=80000)')
py.xlim([-2.3,0.0])
py.ylim([3.2,5.3])
