...
v11p1_dir = '/mount/riachuelo1/hahn/power/manera_mock/v11p1/'
...
for i in nrange:
    ...
    mockname_up_v11p1   = dr11_prefix+str(i+1000)[1:4]+'.v11.1.'+str(n)+'randoms.upweight.grid360.P020000.box3600'
    ...
    mock_up_v11p1 = np.loadtxt(v11p1_dir+mockname_up_v11p1)
    ...
    if i==1:
        ...
        mock_up_v11p1_tot   = mock_up_v11p1[:,1]
        ...
        mock_up_v11p1_tot   = mock_up_v11p1_tot + mock_up_v11p1[:,1]
...
mock_up_v11p1_avg   = mock_up_v11p1_tot/float(n)
...
ratio_up_v11p1_cmass = mock_up_v11p1_avg/power_cmass_dr11_nzw[:,1]
...
ax12.scatter( mock_k, ratio_up_v11p0_cmass, color='b', 
        label=r"$\overline{P(k)}_{\rm{v11.0}}/\overline{P(k)}_{\rm{CMASS}}$")
ax12.scatter( mock_k, ratio_up_v11p1_cmass, color='r', 
        label=r"$\overline{P(k)}_{\rm{v11.1}}/\overline{P(k)}_{\rm{CMASS}}$")
