...
v11p0dir = '/mount/riachuelo1/hahn/power/manera_mock/dr11/'
...
for i in nrange:
    ...
    mockname_up_mkrand_now_v11p0  = fname0+str(i+1000)[1:4]+'.v7.0.'+str(n)+'randoms.upweight.makerandom.grid360.P020000.box3600'
    mockname_up_mkrand_now_v7p0  = fname0+str(i+1000)[1:4]+'.v7.0.'+str(n)+'randoms.upweight.makerandom.grid360.P020000.box3600'
    mockname_up_mkrand_now_v5p2  = fname0+str(i+1000)[1:4]+'.v7.0.'+str(n)+'randoms.upweight.makerandom.grid360.P020000.box3600'
