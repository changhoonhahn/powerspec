...
c      complex dcg(Ngrid/2+1,Ngrid,Ngrid),dcr(Ngrid/2+1,Ngrid,Ngrid)
      ...
      real akfun,I10,I12,I22,I13,I23,I33,P0,alpha,P0m,wsys,rwsys
      ...
      WRITE(*,*) "Ng=",Ng,"Ng,sys=",wsys,"Nr=",Nr,"Nr,sys=",rwsys
      alpha=wsys/rwsys !float(Nr) !now scale random integrals by alpha
      I10=I10*alpha
      I12=I12*alpha
      I22=I22*alpha
      I13=I13*alpha
