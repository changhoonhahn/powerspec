...
for i in nrange:
    ...
    mockname_now_v11p0   = dr11_prefix+str(i+1000)[1:4]+'.v11.0.'+str(n)+'randoms.noweight.grid360.P020000.box3600'
    ...
    mock_now_v11p0 = np.loadtxt(v11p0_dir+mockname_now_v11p0)
    ...
    if i==1:
        ...
        mock_now_v11p0_tot  = mock_now_v11p0[:,1]
        ...
        mock_now_v11p0_tot  = mock_now_v11p0_tot + mock_now_v11p0[:,1]
...
mock_now_v11p0_avg  = mock_now_v11p0_tot/float(n)
...
ratio_now_v11p0_cmass = mock_now_v11p0_avg/power_cmass_dr11_nzw[:,1]
...
ax12.scatter( mock_k, ratio_up_v11p0_cmass, color='m', 
        label=r"$\overline{P(k)}_{\rm{v11.0},\rm{upweight}}/\overline{P(k)}_{\rm{CMASS}}$")
ax12.scatter( mock_k, ratio_now_v11p0_cmass, color='b', 
        label=r"$\overline{P(k)}_{\rm{v11.0},\rm{noweight}}/\overline{P(k)}_{\rm{CMASS}}$")
