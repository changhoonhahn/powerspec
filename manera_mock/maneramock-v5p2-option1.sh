...
ifort -O3 -o FFT-fkp-mock-wboss-v5p2.exe FFT-fkp-mock-wboss-v5p2.f -L/usr/local/fftw_intel_s/lib -lsfftw -lsfftw
...
do
    ...
    do
        ...
        echo ${fname[$i]}
        echo ${FFTname[$i]}
        ./FFT-fkp-mock-wboss-v5p2.exe $Rbox 0 $P0 $nbarfname ${fname[$i]} ${FFTname[$i]}
    done    
done
...
do
    ...
    then
        ...
        ./FFT-fkp-mock-wboss-v5p2.exe $Rbox 1 $P0 $nbarfname $randname ${FFTname[$i]}
    fi
done


ifort -O3 -o power-fkp-mock-wboss-v5p2.exe power-fkp-mock-wboss-v5p2.f
