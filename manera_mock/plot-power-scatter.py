...
for j in range(len(P0)):
    ...
    for i in range(1,11):
        if i < 10:
            opt2name='power_cmass_dr10_north_ir400'+str(i)+'.v5.1.wght.txt_now.grid240.P0'+str(P0[j])+'.box4800'
        elif i < 100:
            opt2name='power_cmass_dr10_north_ir40'+str(i)+'.v5.1.wght.txt_now.grid240.P0'+str(P0[j])+'.box4800'
        else:
            opt2name='power_cmass_dr10_north_ir4'+str(i)+'.v5.1.wght.txt_now.grid240.P0'+str(P0[j])+'.box4800'
    ...
    for ii in range(1,11):
        if ii < 10:
            opt2name='power_cmass_dr10_north_ir400'+str(ii)+'.v5.1.wght.txt_now.grid240.P0'+str(P0[j])+'.box4800'
        elif ii < 100:
            opt2name='power_cmass_dr10_north_ir40'+str(ii)+'.v5.1.wght.txt_now.grid240.P0'+str(P0[j])+'.box4800'
        else:
            opt2name='power_cmass_dr10_north_ir4'+str(ii)+'.v5.1.wght.txt_now.grid240.P0'+str(P0[j])+'.box4800'
        opt2 = np.loadtxt(dir+opt2name)
        opt2diff = [(opt2[x,1]-opt2avg[x])**2 for x in range(len(opt2))]
        opt2scat = opt2scat + opt2diff

    opt2scat = np.sqrt(opt2scat/float(n))/opt2avg
#    ax12.plot(opt2[:,0], opt2scat, color=colors[j],linewidth=2, label="P0="+str(P0[j])+" Option 2")
