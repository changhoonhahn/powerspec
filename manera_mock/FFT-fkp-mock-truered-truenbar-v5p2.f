...
!      write(*,*)'FKP weight P0?'
      ...
      selfunfile="/mount/chichipio2/hahn/data/manera_mock/"//
     $"v5p2/"//nbarfile
...
!         write(*,*) filecoef
         fftname='/mount/chichipio2/hahn/FFT/manera_mock/'//
     $   'v5p2/'//filecoef
         write(*,*) fftname
...
!         write(*,*)'Random Survey File'
         ...
         fname='/mount/chichipio2/hahn/data/manera_mock/'//
     $   'v5p2/'//randomfile
