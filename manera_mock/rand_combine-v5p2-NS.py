...
Sfname = riadir+"cmass_dr10_south_randoms_ir4_combined.v5.2.wghtv.txt"
Nfname = chidir+"cmass_dr10_north_randoms_ir4_combined.v5.2.wghtv.txt"

outputname = riadir+"cmass_dr10_NS_randoms_ir4_combined.v5.2.wghtv.txt"
