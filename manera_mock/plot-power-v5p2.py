...
riadir = "/mount/riachuelo1/hahn/power/manera_mock/v5p2/"
n=0
...
fname0S = "power_cmass_dr10_south_ir4"
fname1 = ".v5.2.wghtv.txt"
fname2 = ".grid240.P0"
fname3 = ".box4800"
for j in range(len(P0)):
    option1=np.zeros([120])
    Soption1 = np.zeros([120])
...
#    cpcorr=np.zeros([120])
    ...
    for i in range(1,101):
        if i < 10:
            ...
            fS_opt1 = fname0S+'00'+str(i)+fname1+"_wboss"+fname2+str(P0[j])+fname3
            ...
            fS_opt1 = fname0S+'0'+str(i)+fname1+"_wboss"+fname2+str(P0[j])+fname3
            ...
            fS_opt1 = fname0S+str(i)+fname1+"_wboss"+fname2+str(P0[j])+fname3
        ...
        Sdata_opt1 = np.loadtxt(riadir + fS_opt1)
...
#        datacp = np.loadtxt(dir+powercp)
        ...
        Soption1 = Soption1 + Sdata_opt1[:,1]
...
#    ax21.loglog(Sdata_opt1[:,0],Soption1/float(n),'m',linewidth=3,label="P0="+str(P0[j])+" South Option 1")
