...
ax11.loglog( mock_k, mock_avg, color='b', linewidth=2, label=r"$\overline{P(k)}$ for PTHalo DR11 v7.0 North")

cmass_data = np.loadtxt("/mount/riachuelo1/hahn/power/power-cmass-dr11v0-N-Anderson-nzw-zlim-ngalsys-3600lbox-360grid-180bin.dat")
ax11.loglog( cmass_data[:,0], cmass_data[:,1], color='r', linewidth=2, label=r"$P(k)$ for CMASS DR11v0 North" )
