...
randname="cmass_dr11_north_"$n"_randoms_ir4_combined.v7.0.txt"
FFTrandname=$FFTdir$FFT"cmass_dr11_north_"$n"_randoms_ir4_combined.v7.0.grid"$grid".P0"$P0".box"$box

echo $datadir$randname 
ipython -noconfirm_exit rand_combine-dr11-v7p0-north.py $n

echo $FFTrandname 
./FFT-fkp-pthalo-dr11-v7p0-upweight.exe $Rbox 1 $P0 $datadir$nbarfname $datadir$randname $FFTrandname
