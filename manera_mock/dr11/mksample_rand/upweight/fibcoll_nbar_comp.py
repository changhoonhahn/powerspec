...
for i in range(1,n+1): 
    ...
    fname_rand7 = 'nbar-normed-cmass_dr11_north_randoms_ir4'+str(i+1000)[1:4]+nameendv7+'upweight.makerandom.txt'
    fname_rand7_test1 = 'nbar-normed-cmass_dr11_north_randoms_ir4'+str(i+1000)[1:4]+nameendv7+'upweight.makerandom.test1.txt'
    fname_rand7_test2 = 'nbar-normed-cmass_dr11_north_randoms_ir4'+str(i+1000)[1:4]+nameendv7+'upweight.makerandom.test2.txt'

    data_upw7    = np.loadtxt(dir7+fname_upw7)
    data_rand7   = np.loadtxt(dir7+fname_rand7)
    data_rand7_test1   = np.loadtxt(dir7+fname_rand7_test1)
    data_rand7_test2   = np.loadtxt(dir7+fname_rand7_test2)

    if i==1: 
        x_axis      = data_upw7[:,0]
        sum_upw7    = data_upw7[:,3]
        sum_rand7   = data_rand7[:,3]
        sum_rand7_test1   = data_rand7_test1[:,3]
        sum_rand7_test2   = data_rand7_test2[:,3]
    else: 
        sum_upw7    = sum_upw7+data_upw7[:,3]
        sum_rand7   = sum_rand7+data_rand7[:,3]
        sum_rand7_test1   = sum_rand7_test1+data_rand7_test1[:,3]
        sum_rand7_test2   = sum_rand7_test2+data_rand7_test2[:,3]
...
ratio_rand_test1_upw7 = sum_rand7_test1/sum_upw7
ratio_rand_test2_upw7 = sum_rand7_test2/sum_upw7
...
ax50.plot(x_axis,ratio_rand_test1_upw7,'g',linewidth=3,
        label=r'${\bar{n}(z)_{\rm{v7.0},\rm{rand},\rm{upweight},\rm{test1}}}/{\bar{n}(z)_{\rm{v7.0},\rm{mock},\rm{upweighted}}}$') 
ax50.plot(x_axis,ratio_rand_test2_upw7,'y',linewidth=3,
        label=r'${\bar{n}(z)_{\rm{v7.0},\rm{rand},\rm{upweight},\rm{test2}}}/{\bar{n}(z)_{\rm{v7.0},\rm{mock},\rm{upweighted}}}$') 
