...
for i in $(seq 1 $n); do 
    ...
    randupw=$datadir"cmass_dr11_north_randoms_ir4"$i".v7.0.upweight.txt"
    if [[ ! -a $randupw ]]; then 
...
wait
randname="cmass_dr11_north_"$n"_randoms_ir4_combined.v7.0.upweight.txt"
FFTrandname=$FFTdir$FFT"cmass_dr11_north_"$n"_randoms_ir4_combined.v7.0.upweight.grid"$grid".P0"$P0".box"$box
