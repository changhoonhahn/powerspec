#!/bin/bash
name0="cmass_dr11_south_ir4"
nameend=".v7.0.wghtv.txt"
randname="cmass_dr11_south_randoms_ir4_combined_wboss.v7.0.wghtv.txt"
nbarfname="nbar-cmass-dr11v0-S-Anderson.dat"
sscale=3600.0
Rbox=1800.0
box="3600"
FFT="FFT"
...
do
    ...
    do
        ...
        echo $fname
        echo ${FFTname[$i]}
#        ./FFT-fkp-mock-dr11-v7p0-wboss.exe $Rbox 0 $P0 $datadir$nbarfname $fname ${FFTname[$i]}
    done    
